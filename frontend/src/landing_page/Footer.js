      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            ...
            <p>
              &copy; 2010 - 2024, Not TradeNest Broking Ltd. All rights reserved.
            </p>
          </div>
          <div className="col">
            <p>Company</p>
            ...
            <br />
            <a href="" style={{ textDecoration: "none" }}>TradeNest.tech</a>
            <br />
            <a href="" style={{ textDecoration: "none" }}>Press & media</a>
            <br />
            <a href="" style={{ textDecoration: "none" }}>TradeNest cares (CSR)</a>
            <br />
          </div>
          <div className="col">
            <p>Support</p>
